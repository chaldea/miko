...
public class TransitionTests
{
    ...
    {
        Transition transition = Transition.For(x => x.Opacity).Duration(0.5f).Linear().Delay(0.1f);
    ...
    {
        Transition transition = Transition.For(x => x.BackgroundColor).Duration(1f).EaseInOut();
    ...
    {
        Transition transition = Transition.For(x => x.Opacity).Duration(0.3f).CubicBezier(0.25f, 0.1f, 0.25f, 1f);
    ...
    {
        Transition transition = Transition.For(x => x.Width).Duration(0.5f);
