...
/// <summary>Item-owned rules, including the contextual list divider overrides.</summary>
internal static class BaseItemStyles
{
    internal static CssObject GenStyle(string mode, IonicTheme t) => new()
    {
