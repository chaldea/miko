...
{
    public BoxShadow(Length offsetX, Length offsetY, Color color, bool inset = false)
        : this(offsetX.ToPixels(0), offsetY.ToPixels(0), 0, 0, color, inset) { }

    public BoxShadow(Length offsetX, Length offsetY, Length blurRadius, Color color, bool inset = false)
        : this(offsetX.ToPixels(0), offsetY.ToPixels(0), blurRadius.ToPixels(0), 0, color, inset) { }
